<template>
  <div class="">
    <!-- Backdrop -->
    <BaseBackdrop :open="isSideMenuOpen" />

    <!-- Mobile Sidebar -->
    <aside
      v-on-clickaway="closeSideMenu"
      v-if="isSideMenuOpen"
      class="
        fixed
        inset-y-0
